...
from bs4 import BeautifulSoup # processing html and xhtml
from csv import writer
from time import sleep
from random import choice

# a list that will store all scraped data
all_quotes = []

base_url = "http://quotes.toscrape.com/"

# part of the page that will change
url = "/page/1"
...
while url:
    ...
    url = next_bin.find("a")["href"] if next_btn else None
    sleep(2)
